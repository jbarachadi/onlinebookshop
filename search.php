...
<html class="no-js">
	...
	<div id="fh5co-page">
		...
		<?php
				...
				if ($stmt = $con->prepare("SELECT title, subject, branch, book_id, img FROM books WHERE title LIKE '%".$search."%' ")) {
						$stmt->execute();
						$stmt->store_result();
						$stmt->bind_result($titre, $matiere, $filiere, $page, $image);
						$stmt->fetch();
						$lien="bookprofil.php?page=".$page;
				}
		?>

		<div id="fh5co-main">		
			<div class="fh5co-narrow-content">
				<h2 class="fh5co-heading animate-box" data-animate-effect="fadeInLeft">Bibliothèque</h2>
				<form method="GET" class="animate-box" data-animate-effect="fadeInLeft" style="width:350px;height:10px;position:absolute;top:90px;right:25px;">
					<input id="mysearch" name="searchitem" class="form-control" type="search" list="headers" placeholder="Recherche" style="width:65%;" />
				...
				<div class="row animate-box" data-animate-effect="fadeInLeft">
					<?php do{ ?>
					<div class="col-md-4 col-sm-6 col-xs-6 col-xxs-12 work-item" style="float:left; width:9em;">
