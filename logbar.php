...
<html class="no-js">
	...
	<body>	
		<div id="fh5co-main">
			<div align="right">
				<h4 style="margin:15px 10px 0 0; font-weight: 550; font-size: 15px; width:90px;">
					<a href="signup.php">
						<div style="color:rgba(1,1,1,1);">
							<img src="images/signup.png" style="width:15px;height:15px;margin:0 4px 0 0;">S'inscrire
						</div>
					</a>
				</h4>
			</div>
			<div style="position:absolute;top:0px;right:112px;">
				<h4 style="margin:15px 10px 0 0; font-weight: 550; font-size: 15px; width:123px;">
					<a href="login.php">
						<div style="color:rgba(1,1,1,1);">
							<img src="images/login.png" style="width:15px;height:15px;margin:0 4px 0 0;">Se connecter
						</div>
					</a>
				</h4>
			</div>
